...
public class InfoTypeAdapter extends BaseAdapter implements Filterable {

    private LayoutInflater mInflater;
    private ArrayList<InfoType> data;
    private MyFilter myFilter;

    public InfoTypeAdapter(Context context, ArrayList<InfoType> data) {
